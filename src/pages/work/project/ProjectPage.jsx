    ...
    <Layout>
      <div className="min-h-screen bg-transparent text-white px-4 pb-6 md:px-14 md:py-6">
        ...
        <div className="mb-12 w-full flex items-center justify-between ">
          ...
          <button className="bg-[#343434] hover:bg-[#444] cursor-pointer text-white px-4 py-2 rounded-xl text-md font-medium transition-colors duration-200 flex items-center gap-2">
         Live Preview
          </button>
            </a> 
            }
